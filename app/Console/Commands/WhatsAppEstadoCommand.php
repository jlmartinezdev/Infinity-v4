...
class WhatsAppEstadoCommand extends Command
{
    ...
    public function handle(WhatsAppService $whatsapp): int
    {
        ...
        $this->table(['clave', 'valor'], [
            ...
            ['agent.enabled', config('whatsapp.agent.enabled') ? 'true' : 'false'],
            ['agent.url', (string) config('whatsapp.agent.url')],
            ['agent.secret', filled(config('whatsapp.agent.secret')) ? '***' : '(vacío)'],
