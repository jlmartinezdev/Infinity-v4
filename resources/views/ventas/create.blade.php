...
<div class="max-w-5xl mx-auto">
    <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">Nueva venta</h1>
                    ...
                    <div>
                        ...
                        <select name="cliente_id" id="cliente_id" required
                            ...
                            @foreach($clientes as $cli)
                                <option value="{{ $cli->cliente_id }}" {{ old('cliente_id') == $cli->cliente_id ? 'selected' : '' }}>{{ $cli->nombre }} {{ $cli->apellido }}</option>
                            @endforeach
                        </select>
                        @error('cliente_id')
                    ...
                    <div>
                        ...
                        <select name="servicio_id" id="servicio_id"
                            ...
                            @foreach($servicios ?? [] as $s)
                                <option value="{{ $s->servicio_id }}" {{ old('servicio_id') == $s->servicio_id ? 'selected' : '' }} data-cliente="{{ $s->cliente_id ?? '' }}">
