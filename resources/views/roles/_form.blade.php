...
<div class="space-y-6">
    <div>
        ...
        <input type="text" name="descripcion" id="descripcion" value="{{ old('descripcion', $role?->descripcion) }}"
            ...
            maxlength="120" required autofocus placeholder="Ej: Administrador, Supervisor, Técnico, Vendedor">
        @error('descripcion')
