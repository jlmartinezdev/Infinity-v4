...
<div class="max-w-2xl mx-auto">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <a href="{{ route('acceso-rapido.edit') }}" class="block p-6 bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-200 dark:border-gray-700 hover:border-green-400 dark:hover:border-green-600 hover:shadow-md transition-all">
            <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Acceso rápido</h2>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Atajos del menú lateral personalizados para tu usuario.</p>
        </a>
        ...
        <a href="{{ route('configuracion.sifen.prueba') }}" class="block p-6 bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-200 dark:border-gray-700 hover:border-green-400 dark:hover:border-green-600 hover:shadow-md transition-all">
            <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Prueba SIFEN</h2>
            <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Laboratorio para crear facturas de prueba y validar el flujo e-Kuatia.</p>
        </a>
