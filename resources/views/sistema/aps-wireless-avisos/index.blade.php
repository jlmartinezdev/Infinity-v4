...
@section('title', 'Alertas caída AP wireless')
...
<div class="max-w-3xl mx-auto space-y-6">
    <div class="flex flex-wrap items-start justify-between gap-3">
        ...
        <a href="{{ route('sistema.aps-wireless.index') }}"
            class="text-sm text-blue-600 dark:text-blue-400 hover:underline">← APs wireless</a>
    </div>
    ...
    <div class="rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-5 space-y-5">
        <form method="POST" action="{{ route('sistema.aps-wireless-avisos.update') }}" class="space-y-5">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Con el ping cada 60&nbsp;s, el valor 3 ≈ 3 minutos sin respuesta.
                </p>
            </div>
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Cada usuario debe tener teléfono WhatsApp. Si todavía no guardaste esta pantalla, se usan los destinatarios de alertas de router.
                    Reutiliza la plantilla Meta <code class="text-xs">router_caido_ping</code> (el nombre del AP va en la variable del equipo).
                </p>
            </div>
        ...
        <form method="POST" action="{{ route('sistema.aps-wireless-avisos.probar') }}"
