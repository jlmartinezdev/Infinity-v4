                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody id="detalles-tbody" class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800">
                        ...
                        <tr class="js-detalle-row">
                            ...
                            <td class="px-4 py-2">
                                <input type="number" name="detalles[{{ $i }}][precio_unitario]" value="{{ is_object($d) ? $d->precio_unitario : ($d['precio_unitario'] ?? '') }}" step="0.01" required class="w-full px-2 py-1.5 rounded border border-gray-300 dark:border-gray-600 text-sm text-right bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:border-purple-500 focus:ring-1 focus:ring-purple-500/20">
                            </td>
                            <td class="px-4 py-2">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function addRow() {
        ...
        tr.innerHTML =
            ...
            '<td class="px-4 py-2"><input type="number" name="detalles[' + indice + '][precio_unitario]" value="0" step="0.01" required class="' + inpNumCl + '"></td>' +
