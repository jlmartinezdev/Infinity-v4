...
@section('title', 'Nueva tarea periódica')
...
<div class="max-w-xl mx-auto">
    ...
    <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">Nueva tarea periódica</h1>
    ...
    <form action="{{ route('tareas-periodicas.store') }}" method="POST" class="bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-200 dark:border-gray-700 p-6 space-y-4">
        @csrf
        ...
        <div>
            ...
            <input type="text" name="accion" id="accion" value="{{ old('accion') }}" required maxlength="100" placeholder="Ej: generar_facturas, cortar_servicios"
                   class="mt-1 w-full px-3 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 shadow-sm focus:border-green-500 focus:ring-2 focus:ring-green-500/20 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400">
        </div>
