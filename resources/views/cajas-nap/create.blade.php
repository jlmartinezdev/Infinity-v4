        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <select name="salida_pon_id" id="salida_pon_id" class="mt-1 {{ $inputClass }}">
                    ...
                    @foreach($salidas as $sp)
                        <option value="{{ $sp->salida_pon_id }}" data-nodo="{{ $sp->nodo_id }}" {{ (string) old('salida_pon_id') === (string) $sp->salida_pon_id ? 'selected' : '' }}>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="splitter_primer_nivel" id="splitter_primer_nivel" value="{{ old('splitter_primer_nivel') }}" maxlength="10" class="mt-1 {{ $inputClass }}" placeholder="ej: 1x4">
                </div>
                <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="codigo" id="codigo" value="{{ old('codigo') }}" required maxlength="50"
                        class="mt-1 {{ $inputClass }}" placeholder="ej: NAP-001" autocomplete="off">
