...
<div class="max-w-2xl mx-auto">
    ...
    <form action="{{ route('sistema.cajas-nap.store') }}" method="POST" class="bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="codigo" id="codigo" value="{{ old('codigo') }}" required maxlength="50"
                        class="mt-1 w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700" placeholder="ej: NAP-001">
                ...
                <div>
                    ...
                    <select name="tipo" id="tipo" required class="mt-1 w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700">
                        <option value="primaria" {{ old('tipo', 'secundaria') === 'primaria' ? 'selected' : '' }}>Primaria</option>
                        <option value="secundaria" {{ old('tipo', 'secundaria') === 'secundaria' ? 'selected' : '' }}>Secundaria</option>
                    </select>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="lat" id="lat" value="{{ old('lat') }}" step="0.0000001" min="-90" max="90"
                        class="mt-1 w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700" placeholder="-25.2637">
                ...
                <div>
                    ...
                    <input type="number" name="lon" id="lon" value="{{ old('lon') }}" step="0.0000001" min="-180" max="180"
                        class="mt-1 w-full rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700" placeholder="-57.5759">
        ...
        <div class="mt-6 flex gap-3">
            <button type="submit" class="px-4 py-2 bg-purple-600 text-white rounded-lg font-medium hover:bg-purple-700">Crear caja NAP</button>
