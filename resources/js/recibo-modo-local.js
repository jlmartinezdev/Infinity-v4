 ...
 */
const STORAGE_KEY = 'reciboModo';

const MODOS_VALIDOS = ['con_grafico', 'sin_grafico', 'sin_grafico_linea'];
...
function aplicarModo(modo) {
    const m = MODOS_VALIDOS.includes(modo) ? modo : 'con_grafico';
    document.querySelectorAll('.recibo-modo-wrapper').forEach((w) => {
        w.setAttribute('data-recibo-modo', m);
    });
    document.querySelectorAll('a.js-recibo-pdf-link').forEach((a) => {
