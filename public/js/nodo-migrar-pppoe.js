...
/***/ "./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/NodoMigrarPppoe.vue?vue&type=script&lang=js"
/*!**********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/NodoMigrarPppoe.vue?vue&type=script&lang=js ***!
  \**********************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    puedeEjecutar: function puedeEjecutar() {
    ...
    mensajeClase: function mensajeClase() {
      return this.mensajeEsError ? 'bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-800 dark:text-red-200' : 'bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 text-green-800 dark:text-green-200';
    }
  },
  ...
  methods: {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            case 0:
              _context.p = 0;
              _context.n = 1;
              return axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(_this.urlDatos, {
                headers: _this.headers()
              });
            case 1:
              _yield$axios$get = _context.v;
              data = _yield$axios$get.data;
              _this.routersNodo = data.routers_nodo || [];
              _this.routersTodos = data.routers_todos || [];
              _context.n = 3;
              break;
            case 2:
              _context.p = 2;
              _t = _context.v;
              _this.mostrarMensaje('No se pudieron cargar los routers.', true);
            case 3:
              return _context.a(2);
          }
        }, _callee, null, [[0, 2]]);
    ...
    onRouterOrigenChange: function onRouterOrigenChange() {
      var _this2 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            case 0:
              _this2.servicios = [];
              _this2.servicioIdsSeleccionados = [];
              if (_this2.routerOrigenId) {
                _context2.n = 1;
                break;
              }
              return _context2.a(2);
            case 1:
              _this2.cargandoServicios = true;
              _context2.p = 2;
              _context2.n = 3;
              return axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(_this2.urlServicios, {
                params: {
                  router_origen_id: _this2.routerOrigenId
                },
            ...
            case 3:
              ...
              _this2.servicios = data.servicios || [];
              _context2.n = 5;
              break;
            case 4:
              _context2.p = 4;
              _t2 = _context2.v;
              _this2.mostrarMensaje('Error al cargar servicios.', true);
            case 5:
              _context2.p = 5;
              _this2.cargandoServicios = false;
    ...
    onRouterDestinoChange: function onRouterDestinoChange() {
      var _this3 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        var _yield$axios$get3, data, _t3;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.p = _context3.n) {
            case 0:
              _this3.poolDestinoId = '';
              _this3.poolsDestino = [];
              if (!(!_this3.routerDestinoId || _this3.modo !== 'mover')) {
                _context3.n = 1;
                break;
              }
              return _context3.a(2);
            case 1:
              _this3.cargandoPools = true;
              _context3.p = 2;
              _context3.n = 3;
              return axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(_this3.urlPools, {
                params: {
                  router_destino_id: _this3.routerDestinoId
                },
            ...
            case 3:
              ...
              _this3.poolsDestino = data.pools || [];
              _context3.n = 5;
              break;
            case 4:
              _context3.p = 4;
              _t3 = _context3.v;
              _this3.mostrarMensaje('Error al cargar pools del router destino.', true);
            case 5:
              _context3.p = 5;
              _this3.cargandoPools = false;
    ...
    seleccionarTodos: function seleccionarTodos() {
      this.servicioIdsSeleccionados = this.servicios.map(function (s) {
        return s.servicio_id;
      });
    },
    limpiarSeleccion: function limpiarSeleccion() {
      this.servicioIdsSeleccionados = [];
    },
    mostrarMensaje: function mostrarMensaje(texto) {
      var esError = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      this.mensaje = texto;
    ...
    ejecutar: function ejecutar() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        var accion, n, _yield$axios$post, data, res, _err$response, msg, _t4;
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.p = _context4.n) {
            case 0:
              if (_this4.puedeEjecutar) {
                _context4.n = 1;
                break;
              }
              return _context4.a(2);
            case 1:
              accion = _this4.modo === 'mover' ? 'mover' : 'copiar';
              n = _this4.servicioIdsSeleccionados.length;
              if (confirm("\xBF".concat(accion === 'mover' ? 'Mover' : 'Copiar', " ").concat(n, " usuario(s) PPPoE?"))) {
                _context4.n = 2;
                break;
              }
              return _context4.a(2);
            case 2:
              _this4.ejecutando = true;
              _this4.mensaje = '';
              _this4.resultadoDetalles = [];
              _this4.resultadoErrores = [];
              _context4.p = 3;
              _context4.n = 4;
              return axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(_this4.urlEjecutar, {
                modo: _this4.modo,
                router_origen_id: Number(_this4.routerOrigenId),
                router_destino_id: Number(_this4.routerDestinoId),
                pool_destino_id: _this4.poolDestinoId ? Number(_this4.poolDestinoId) : null,
                asignar_ip_automatica: _this4.asignarIpAutomatica,
                servicio_ids: _this4.servicioIdsSeleccionados
              }, {
            ...
            case 4:
              ...
              res = data.resultado || {};
              _this4.resultadoDetalles = res.detalles || [];
              _this4.resultadoErrores = res.errores || [];
              _this4.mostrarMensaje(data.message || 'Listo.', !data.success);
              if (!data.success) {
                _context4.n = 6;
                break;
              }
              _context4.n = 5;
              return _this4.onRouterOrigenChange();
            case 5:
              _this4.servicioIdsSeleccionados = [];
            case 6:
              _context4.n = 8;
              break;
            case 7:
              _context4.p = 7;
              _t4 = _context4.v;
              msg = ((_err$response = _t4.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || _t4.message || 'Error al ejecutar.';
              _this4.mostrarMensaje(msg, true);
            case 8:
              _context4.p = 8;
              _this4.ejecutando = false;
...
/***/ "./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/NodoMigrarPppoe.vue?vue&type=template&id=e7270a32"
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/NodoMigrarPppoe.vue?vue&type=template&id=e7270a32 ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var _hoisted_6 = {
  key: 0,
  class: "mb-4 p-4 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 text-amber-800 dark:text-amber-200 text-sm"
};
var _hoisted_7 = {
...
var _hoisted_10 = {
  class: "flex items-center gap-2 text-sm text-gray-700 dark:text-gray-300 mt-8 cursor-pointer"
};
var _hoisted_11 = {
  class: "grid grid-cols-1 md:grid-cols-2 gap-4"
};
...
var _hoisted_23 = {
  key: 3,
  class: "overflow-x-auto border border-gray-200 dark:border-gray-700 rounded-lg max-h-96 overflow-y-auto"
};
var _hoisted_24 = {
...
var _hoisted_35 = {
  key: 1,
  class: "mt-6 bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-200 dark:border-gray-700 p-4"
};
var _hoisted_36 = {
  class: "text-sm text-gray-700 dark:text-gray-300 space-y-1 list-disc list-inside"
};
var _hoisted_37 = {
  key: 0,
  class: "mt-3 text-sm text-red-600 dark:text-red-400 space-y-1 list-disc list-inside"
};
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
    href: $props.urlIndex,
    class: "text-sm text-purple-600 dark:text-purple-400 hover:underline mb-1 inline-block"
  }, "← Volver a nodos", 8 /* PROPS */, _hoisted_3), _cache[12] || (_cache[12] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h1", {
    class: "text-2xl font-bold text-gray-900 dark:text-gray-100"
  }, "Migrar / copiar PPPoE", -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_4, [_cache[11] || (_cache[11] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" Nodo: ", -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_5, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($props.nodo.descripcion || '#' + $props.nodo.nodo_id), 1 /* TEXT */)])])]), !$props.canEditar ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_6, " Solo tenés permiso de lectura. Necesitás «referenciales.editar» para ejecutar la migración. ")) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_7, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_8, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [_cache[14] || (_cache[14] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
  }, "Modo", -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
  ...
  }, _toConsumableArray(_cache[13] || (_cache[13] = [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", {
    value: "mover"
  }, "Mover (quita del RB origen, actualiza servicio y sincroniza destino)", -1 /* CACHED */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", {
    value: "copiar"
  }, "Copiar (crea en RB destino sin quitar origen ni cambiar BD)", -1 /* CACHED */)])), 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $data.modo]])]), $data.modo === 'mover' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_9, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", _hoisted_10, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
    "onUpdate:modelValue": _cache[1] || (_cache[1] = function ($event) {
      return $data.asignarIpAutomatica = $event;
    }),
    type: "checkbox",
    class: "rounded border-gray-300 text-purple-600 focus:ring-purple-500"
  }, null, 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelCheckbox, $data.asignarIpAutomatica]]), _cache[15] || (_cache[15] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" Asignar IP automática del pool destino ", -1 /* CACHED */))])])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_11, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [_cache[17] || (_cache[17] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
  }, "Router origen (este nodo)", -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
    "onUpdate:modelValue": _cache[2] || (_cache[2] = function ($event) {
      return $data.routerOrigenId = $event;
    }),
    class: "w-full py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100",
    onChange: _cache[3] || (_cache[3] = function () {
      return $options.onRouterOrigenChange && $options.onRouterOrigenChange.apply($options, arguments);
    })
  }, [_cache[16] || (_cache[16] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", {
    value: ""
  }, "— Seleccionar —", -1 /* CACHED */)), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.routersNodo, function (r) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: r.router_id,
      value: String(r.router_id)
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(r.label), 9 /* TEXT, PROPS */, _hoisted_12);
  }), 128 /* KEYED_FRAGMENT */))], 544 /* NEED_HYDRATION, NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $data.routerOrigenId]])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [_cache[19] || (_cache[19] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
  }, "Router destino", -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
    "onUpdate:modelValue": _cache[4] || (_cache[4] = function ($event) {
      return $data.routerDestinoId = $event;
    }),
    class: "w-full py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100",
    onChange: _cache[5] || (_cache[5] = function () {
      return $options.onRouterDestinoChange && $options.onRouterDestinoChange.apply($options, arguments);
    })
  }, [_cache[18] || (_cache[18] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", {
    value: ""
  }, "— Seleccionar —", -1 /* CACHED */)), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.routersTodos, function (r) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: 'd-' + r.router_id,
      value: String(r.router_id)
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(r.label), 9 /* TEXT, PROPS */, _hoisted_13);
  }), 128 /* KEYED_FRAGMENT */))], 544 /* NEED_HYDRATION, NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $data.routerDestinoId]])])]), $data.modo === 'mover' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_14, [_cache[20] || (_cache[20] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
  }, "Pool destino", -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
    "onUpdate:modelValue": _cache[6] || (_cache[6] = function ($event) {
      return $data.poolDestinoId = $event;
    }),
    disabled: !$data.routerDestinoId || $data.cargandoPools,
  ...
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", _hoisted_16, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.cargandoPools ? 'Cargando pools…' : '— Seleccionar pool —'), 1 /* TEXT */), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.poolsDestino, function (p) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: p.pool_id,
      value: String(p.pool_id)
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(p.label), 9 /* TEXT, PROPS */, _hoisted_17);
  }), 128 /* KEYED_FRAGMENT */))], 8 /* PROPS */, _hoisted_15), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $data.poolDestinoId]])])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $data.mensaje ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 1,
    class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)([$options.mensajeClase, "p-4 rounded-lg text-sm whitespace-pre-wrap"])
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.mensaje), 3 /* TEXT, CLASS */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_18, [_cache[22] || (_cache[22] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", {
    class: "text-lg font-semibold text-gray-900 dark:text-gray-100"
  }, "Servicios en router origen", -1 /* CACHED */)), $data.servicios.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_19, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    class: "text-purple-600 dark:text-purple-400 hover:underline",
    onClick: _cache[7] || (_cache[7] = function () {
      return $options.seleccionarTodos && $options.seleccionarTodos.apply($options, arguments);
    })
  }, "Seleccionar todos"), _cache[21] || (_cache[21] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
    class: "text-gray-400"
    ...
    onClick: _cache[8] || (_cache[8] = function () {
      return $options.limpiarSeleccion && $options.limpiarSeleccion.apply($options, arguments);
    })
  }, "Limpiar")])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), $data.cargandoServicios ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_20, "Cargando servicios…")) : $data.routerOrigenId && !$data.servicios.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_21, "No hay servicios con usuario PPPoE en este router.")) : !$data.routerOrigenId ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_22, "Elegí un router origen para listar servicios.")) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_23, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("table", _hoisted_24, [_cache[23] || (_cache[23] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("thead", {
    class: "bg-gray-50 dark:bg-gray-700/50 sticky top-0"
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("tr", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
    class: "px-3 py-2 w-10"
  }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
    class: "px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase"
  }, "Usuario PPPoE"), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
    class: "px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase"
  }, "Cliente"), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
    class: "px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase"
  }, "Plan"), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
    class: "px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase"
  }, "IP"), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("th", {
    class: "px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase"
  }, "Estado")])], -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("tbody", _hoisted_25, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.servicios, function (s) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("tr", {
      key: s.servicio_id,
      class: "hover:bg-gray-50 dark:hover:bg-gray-700/30"
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_26, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
      "onUpdate:modelValue": _cache[9] || (_cache[9] = function ($event) {
        return $data.servicioIdsSeleccionados = $event;
      }),
      type: "checkbox",
      value: s.servicio_id,
      class: "rounded border-gray-300 text-purple-600 focus:ring-purple-500"
    }, null, 8 /* PROPS */, _hoisted_27), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelCheckbox, $data.servicioIdsSeleccionados]])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_28, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(s.usuario_pppoe), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_29, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(s.cliente), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_30, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(s.plan), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_31, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(s.ip || '—'), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("td", _hoisted_32, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(s.estado_label), 1 /* TEXT */)]);
  }), 128 /* KEYED_FRAGMENT */))])])]))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_33, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    disabled: !$options.puedeEjecutar || $data.ejecutando,
    ...
    onClick: _cache[10] || (_cache[10] = function () {
      return $options.ejecutar && $options.ejecutar.apply($options, arguments);
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.ejecutando ? 'Procesando…' : $data.modo === 'mover' ? 'Mover seleccionados' : 'Copiar seleccionados'), 9 /* TEXT, PROPS */, _hoisted_34)])]), $data.resultadoDetalles.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_35, [_cache[24] || (_cache[24] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", {
    class: "font-semibold text-gray-900 dark:text-gray-100 mb-2"
  }, "Detalle", -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("ul", _hoisted_36, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.resultadoDetalles, function (d, i) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: 'ok-' + i
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(d), 1 /* TEXT */);
  }), 128 /* KEYED_FRAGMENT */))]), $data.resultadoErrores.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("ul", _hoisted_37, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.resultadoErrores, function (e) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("li", {
      key: 'err-' + e.servicio_id
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(e.usuario) + ": " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(e.error), 1 /* TEXT */);
...
/***/ "./resources/js/components/NodoMigrarPppoe.vue"
/*!*****************************************************!*\
  !*** ./resources/js/components/NodoMigrarPppoe.vue ***!
  \*****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _NodoMigrarPppoe_vue_vue_type_template_id_e7270a32__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./NodoMigrarPppoe.vue?vue&type=template&id=e7270a32 */ "./resources/js/components/NodoMigrarPppoe.vue?vue&type=template&id=e7270a32");
/* harmony import */ var _NodoMigrarPppoe_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./NodoMigrarPppoe.vue?vue&type=script&lang=js */ "./resources/js/components/NodoMigrarPppoe.vue?vue&type=script&lang=js");
...
;
const __exports__ = /*#__PURE__*/(0,_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_NodoMigrarPppoe_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_NodoMigrarPppoe_vue_vue_type_template_id_e7270a32__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/NodoMigrarPppoe.vue"]])
/* hot reload */
if (false) // removed by dead control flow
{}
...
/***/ "./resources/js/components/NodoMigrarPppoe.vue?vue&type=script&lang=js"
/*!*****************************************************************************!*\
  !*** ./resources/js/components/NodoMigrarPppoe.vue?vue&type=script&lang=js ***!
  \*****************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* reexport safe */ _node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_NodoMigrarPppoe_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"])
/* harmony export */ });
/* harmony import */ var _node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_NodoMigrarPppoe_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./NodoMigrarPppoe.vue?vue&type=script&lang=js */ "./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/NodoMigrarPppoe.vue?vue&type=script&lang=js");
 

/***/ },

/***/ "./resources/js/components/NodoMigrarPppoe.vue?vue&type=template&id=e7270a32"
/*!***********************************************************************************!*\
  !*** ./resources/js/components/NodoMigrarPppoe.vue?vue&type=template&id=e7270a32 ***!
  \***********************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_NodoMigrarPppoe_vue_vue_type_template_id_e7270a32__WEBPACK_IMPORTED_MODULE_0__.render)
/* harmony export */ });
/* harmony import */ var _node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_NodoMigrarPppoe_vue_vue_type_template_id_e7270a32__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./NodoMigrarPppoe.vue?vue&type=template&id=e7270a32 */ "./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/NodoMigrarPppoe.vue?vue&type=template&id=e7270a32");


/***/ },

/***/ "./resources/js/nodo-migrar-pppoe.js"
/*!*******************************************!*\
  !*** ./resources/js/nodo-migrar-pppoe.js ***!
  \*******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _components_NodoMigrarPppoe_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/components/NodoMigrarPppoe.vue */ "./resources/js/components/NodoMigrarPppoe.vue");




var el = document.getElementById('nodo-migrar-pppoe-app');
if (el) {
  var _cfg$canEditar;
  var cfg = typeof window.__NODO_MIGRAR_PPPOE_CONFIG__ !== 'undefined' ? window.__NODO_MIGRAR_PPPOE_CONFIG__ : {};
  (0,vue__WEBPACK_IMPORTED_MODULE_2__.createApp)(_components_NodoMigrarPppoe_vue__WEBPACK_IMPORTED_MODULE_3__["default"], {
    nodo: cfg.nodo || {},
    canEditar: (_cfg$canEditar = cfg.canEditar) !== null && _cfg$canEditar !== void 0 ? _cfg$canEditar : false,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./resources/js/nodo-migrar-pppoe.js")))
