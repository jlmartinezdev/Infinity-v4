...
/***/ "./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/Sidebar.vue?vue&type=script&setup=true&lang=js"
/*!*************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/Sidebar.vue?vue&type=script&setup=true&lang=js ***!
  \*************************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var STORAGE_KEY_MENU = 'infinity_sidebar_menu_expanded';
var STORAGE_KEY_DESKTOP = 'infinity_sidebar_desktop_expanded';
var STORAGE_KEY_NAV_SCROLL = 'infinity_sidebar_nav_scroll';
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  __name: 'Sidebar',
  props: {
    user: {
  ...
  emits: ['toggle-sidebar', 'menu-click', 'update:desktopExpanded'],
  setup: function setup(__props, _ref) {
    ...
    function loadMenuExpanded() {
      try {
        var s = localStorage.getItem(STORAGE_KEY_MENU);
    ...
    function loadDesktopExpanded() {
      try {
        var s = localStorage.getItem(STORAGE_KEY_DESKTOP);
        return s !== 'false';
      } catch (_unused2) {
        return true;
      }
    ...
    var props = __props;
    var emit = __emit;
    var menuExpanded = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)(loadMenuExpanded());
    var desktopExpanded = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)(loadDesktopExpanded());
    var sidebarOpen = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)(false);
    var navEl = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)(null);
    var navScrollTimeout = null;
    var isOpen = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(function () {
      return props.isOpen !== null && props.isOpen !== undefined ? props.isOpen : sidebarOpen.value;
    });
    ...
    function toggleSubmenu(item) {
      ...
      var key = item.name;
      var next = !isSubmenuExpanded(item);
      menuExpanded.value = _objectSpread(_objectSpread({}, menuExpanded.value), {}, _defineProperty({}, key, next));
      saveMenuExpanded(menuExpanded.value);
    }
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.watch)(menuExpanded, function (val) {
      return saveMenuExpanded(val);
    }, {
      deep: true
    });
    var toggleDesktop = function toggleDesktop() {
    ...
    function notifyDesktopChange() {
      ...
      window.dispatchEvent(new CustomEvent('sidebar-desktop-change', {
        detail: {
          expanded: desktopExpanded.value
        }
      }));
    }
    function closeSidebar() {
      if (props.isOpen !== null && props.isOpen !== undefined) emit('toggle-sidebar');else sidebarOpen.value = false;
    }
    function emitToggle() {
      if (props.isOpen !== null && props.isOpen !== undefined) emit('toggle-sidebar');else sidebarOpen.value = !sidebarOpen.value;
    }
    ...
    var WifiIcon = {
      template: "<svg fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M8.111 16.404a5.5 5.5 0 017.778 0M12 20h.01m-7.08-7.071c3.904-3.905 10.236-3.905 14.141 0M1.394 9.393c5.857-5.857 15.355-5.857 21.213 0\"></path></svg>"
    };
    ...
    var TicketIcon = {
      template: "<svg fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z\"></path></svg>"
    };
    var CogIcon = {
    ...
    var ClipboardListIcon = {
      template: "<svg fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01\"></path></svg>"
    };
    var CubeIcon = {
    ...
    var defaultMenu = [{
      ...
      submenu: [{
        ...
        name: 'mapas-pedidos',
        label: 'Mapas de pedidos',
        path: '/clientes/mapas-pedidos'
      }]
    }, {
      name: 'servicios',
      label: 'Servicios',
    ...
    var filteredMenu = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(function () {
    ...
    var userInitials = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(function () {
      var _props$user;
      if (!((_props$user = props.user) !== null && _props$user !== void 0 && _props$user.name)) return 'U';
      var names = props.user.name.split(' ');
    ...
    function isSubmenuActive(item) {
      return item.submenu && item.submenu.some(function (s) {
        return isActive(s.path);
      });
    }
    ...
    function restoreNavScroll() {
      try {
        var y = parseInt(localStorage.getItem(STORAGE_KEY_NAV_SCROLL), 10);
    ...
    var __returned__ = {
      STORAGE_KEY_MENU: STORAGE_KEY_MENU,
      STORAGE_KEY_DESKTOP: STORAGE_KEY_DESKTOP,
      STORAGE_KEY_NAV_SCROLL: STORAGE_KEY_NAV_SCROLL,
      loadMenuExpanded: loadMenuExpanded,
      saveMenuExpanded: saveMenuExpanded,
      loadDesktopExpanded: loadDesktopExpanded,
      saveDesktopExpanded: saveDesktopExpanded,
      props: props,
      emit: emit,
      ...
      navEl: navEl,
      get navScrollTimeout() {
        return navScrollTimeout;
      },
      set navScrollTimeout(v) {
        navScrollTimeout = v;
      },
      isOpen: isOpen,
      ...
      notifyDesktopChange: notifyDesktopChange,
      ...
      restoreNavScroll: restoreNavScroll,
...
/***/ "./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/Sidebar.vue?vue&type=template&id=81fbb27e"
/*!******************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/Sidebar.vue?vue&type=template&id=81fbb27e ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var _hoisted_1 = {
  class: "h-16 flex items-center justify-center border-b border-gray-800 gap-2"
};
var _hoisted_2 = {
  key: 0,
...
var _hoisted_12 = {
  key: 0,
  class: "ml-2 bg-purple-600 text-white text-xs px-2 py-0.5 rounded-full flex-shrink-0"
};
var _hoisted_13 = {
  key: 0,
...
var _hoisted_33 = {
  key: 0,
  class: "border-t border-gray-800 p-4 mt-4"
};
var _hoisted_34 = {
  class: "flex items-center space-x-3"
};
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Desktop Sidebar (collapsible) - Siempre tema oscuro "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("aside", {
    ...
    class: "w-8 h-8 bg-gradient-to-br from-purple-600 to-pink-600 rounded-lg flex-shrink-0"
  }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
    class: "text-xl font-bold text-gray-100 truncate"
  }, "Infinity ISP")], -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    onClick: $setup.toggleDesktop,
    class: "p-1.5 rounded-lg hover:bg-gray-800 transition-colors flex-shrink-0",
    "aria-label": "Colapsar menú"
  }, _toConsumableArray(_cache[0] || (_cache[0] = [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("svg", {
  ...
  })], -1 /* CACHED */)])))])) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
    key: 1,
    type: "button",
    onClick: $setup.toggleDesktop,
    ...
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
      key: item.name
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Item without submenu "), !item.submenu ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("a", {
      key: 0,
      href: item.path,
      onClick: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function ($event) {
        return $setup.handleMenuClick(item);
      }, ["prevent"]),
      class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(['flex items-center min-w-0 px-3 py-2.5 rounded-lg text-gray-200 hover:bg-gray-800 transition-colors group gap-2', $setup.isMenuItemActive(item) ? 'bg-purple-900/20 text-purple-400' : ''])
      ...
      class: "w-5 h-5 flex-shrink-0"
    })), $setup.desktopExpanded ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_8, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.label), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $setup.desktopExpanded ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
      key: 1,
      class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["transition-transform duration-200", {
        'rotate-180': $setup.isSubmenuExpanded(item)
      }])
      ...
      "stroke-width": "2",
      d: "M19 9l-7 7-7-7"
    })], -1 /* CACHED */)])), 2 /* CLASS */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 10 /* CLASS, PROPS */, _hoisted_7), $setup.desktopExpanded && $setup.isSubmenuExpanded(item) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_9, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(item.submenu, function (sub) {
      return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("a", {
        key: sub.name,
        href: sub.path,
        onClick: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function ($event) {
          return $setup.handleMenuClick(sub);
        }, ["prevent"]),
        class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(['flex items-center justify-between px-3 py-2 text-sm rounded-lg transition-colors truncate', $setup.isActive(sub.path) ? 'text-purple-400 bg-purple-900/20' : 'text-gray-300 hover:bg-gray-800 hover:text-gray-100'])
      }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_11, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(sub.label), 1 /* TEXT */), sub.badge ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_12, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(sub.badge), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 10 /* CLASS, PROPS */, _hoisted_10);
    }), 128 /* KEYED_FRAGMENT */))])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])], 2112 /* STABLE_FRAGMENT, DEV_ROOT_FRAGMENT */))], 64 /* STABLE_FRAGMENT */);
  }), 128 /* KEYED_FRAGMENT */))], 34 /* CLASS, NEED_HYDRATION */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Footer usuario (solo desktop, cuando expandido) "), $props.user && $setup.desktopExpanded ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_13, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_14, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_15, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_16, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_17, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.userInitials), 1 /* TEXT */)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_18, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_19, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)((_$props$user = $props.user) === null || _$props$user === void 0 ? void 0 : _$props$user.name), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_20, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)((_$props$user2 = $props.user) === null || _$props$user2 === void 0 ? void 0 : _$props$user2.email), 1 /* TEXT */)])])])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 2 /* CLASS */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Mobile Sidebar (Modal) - Siempre tema oscuro "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("aside", _hoisted_21, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    class: "h-16 flex items-center justify-between px-4 border-b border-gray-800 sticky top-0 bg-gray-900 z-10"
  ...
  })], -1 /* CACHED */)])))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("nav", _hoisted_22, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($setup.filteredMenu, function (item) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
      key: item.name
    }, [!item.submenu ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("a", {
      key: 0,
      href: item.path,
      onClick: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function ($event) {
        return $setup.handleMenuClick(item);
      }, ["prevent"]),
      class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(['flex items-center min-w-0 gap-2 px-3 py-2.5 rounded-lg text-gray-200 hover:bg-gray-800 transition-colors', $setup.isMenuItemActive(item) ? 'bg-purple-900/20 text-purple-400' : ''])
    }, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)((0,vue__WEBPACK_IMPORTED_MODULE_0__.resolveDynamicComponent)($setup.iconComponent(item.icon)), {
      class: "w-5 h-5 flex-shrink-0"
      ...
      class: "w-5 h-5 flex-shrink-0"
    })), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_28, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(item.label), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
      class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["transition-transform duration-200", {
        'rotate-180': $setup.isSubmenuExpanded(item)
      }])
      ...
      "stroke-width": "2",
      d: "M19 9l-7 7-7-7"
    })], -1 /* CACHED */)])), 2 /* CLASS */)], 10 /* CLASS, PROPS */, _hoisted_27), $setup.isSubmenuExpanded(item) ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_29, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)(item.submenu, function (sub) {
      return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("a", {
        key: sub.name,
        href: sub.path,
        onClick: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function ($event) {
        ...
        class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(['flex items-center justify-between px-3 py-2 text-sm rounded-lg transition-colors', $setup.isActive(sub.path) ? 'text-purple-400 bg-purple-900/20' : 'text-gray-300 hover:bg-gray-800 hover:text-gray-100'])
      }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_31, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(sub.label), 1 /* TEXT */), sub.badge ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_32, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(sub.badge), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 10 /* CLASS, PROPS */, _hoisted_30);
    }), 128 /* KEYED_FRAGMENT */))])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]))], 64 /* STABLE_FRAGMENT */);
  }), 128 /* KEYED_FRAGMENT */))]), $props.user ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_33, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_34, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_35, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_36, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_37, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.userInitials), 1 /* TEXT */)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_38, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_39, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)((_$props$user3 = $props.user) === null || _$props$user3 === void 0 ? void 0 : _$props$user3.name), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_40, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)((_$props$user4 = $props.user) === null || _$props$user4 === void 0 ? void 0 : _$props$user4.email), 1 /* TEXT */)])])])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vShow, $setup.isOpen]]), $setup.isOpen ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 0,
    onClick: $setup.closeSidebar,
...
var el = document.getElementById('sidebar-app');
if (el) {
  var cfg = typeof window.__SIDEBAR_CONFIG__ !== 'undefined' ? window.__SIDEBAR_CONFIG__ : {};
  var app = (0,vue__WEBPACK_IMPORTED_MODULE_2__.createApp)(_components_Sidebar_vue__WEBPACK_IMPORTED_MODULE_3__["default"], {
    menu: cfg.menu || null,
    user: cfg.user || null,
    isOpen: undefined
  });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* reexport safe */ _node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_Sidebar_vue_vue_type_script_setup_true_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"])
/* harmony export */ });
/* harmony import */ var _node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_Sidebar_vue_vue_type_script_setup_true_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./Sidebar.vue?vue&type=script&setup=true&lang=js */ "./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/Sidebar.vue?vue&type=script&setup=true&lang=js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_Sidebar_vue_vue_type_template_id_81fbb27e__WEBPACK_IMPORTED_MODULE_0__.render)
/* harmony export */ });
/* harmony import */ var _node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_Sidebar_vue_vue_type_template_id_81fbb27e__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./Sidebar.vue?vue&type=template&id=81fbb27e */ "./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/Sidebar.vue?vue&type=template&id=81fbb27e");
