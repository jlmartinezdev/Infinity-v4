...
/***/ "./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/TareasKanban.vue?vue&type=script&setup=true&lang=js"
/*!******************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/TareasKanban.vue?vue&type=script&setup=true&lang=js ***!
  \******************************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    var props = __props;
    var tareasList = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)(_toConsumableArray(props.tareas || []));
    var modalOpen = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)(false);
    var editando = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)(null);
    ...
    var dragTask = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)(null);
    var tareasPorColumna = function tareasPorColumna(estado) {
      return tareasList.value.filter(function (t) {
    ...
    function abrirEditar(t) {
      var _t$asignado$usuario_i, _t$asignado;
      editando.value = t;
      form.value = {
        titulo: t.titulo,
        ...
        asignado_id: (_t$asignado$usuario_i = (_t$asignado = t.asignado) === null || _t$asignado === void 0 ? void 0 : _t$asignado.usuario_id) !== null && _t$asignado$usuario_i !== void 0 ? _t$asignado$usuario_i : null,
    ...
    function _guardar() {
      _guardar = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var _yield$axios$put, data, i, _yield$axios$post, _data;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              ...
              _context.n = 1;
              return axios__WEBPACK_IMPORTED_MODULE_1__["default"].put(props.urlUpdate.replace('__id__', editando.value.id), _objectSpread(_objectSpread({}, form.value), {}, {
            ...
            case 1:
              ...
              i = tareasList.value.findIndex(function (t) {
                return t.id === data.id;
              });
              if (i >= 0) tareasList.value[i] = data;else tareasList.value.push(data);
              _context.n = 4;
              break;
            case 2:
              _context.n = 3;
              return axios__WEBPACK_IMPORTED_MODULE_1__["default"].post(props.urlStore, _objectSpread(_objectSpread({}, form.value), {}, {
                _token: props.csrfToken
              }), {
                headers: {
                  'X-CSRF-TOKEN': props.csrfToken,
    ...
    function _onDrop() {
      _onDrop = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(ev, estadoDestino) {
        var t, col, orden, _yield$axios$post2, data, i, _t;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            case 0:
              ev.preventDefault();
              t = dragTask.value;
              if (!(!t || t.estado === estadoDestino)) {
                _context2.n = 1;
                break;
              }
              return _context2.a(2);
            case 1:
              col = tareasPorColumna(estadoDestino);
              orden = col.length;
              _context2.p = 2;
              _context2.n = 3;
              return axios__WEBPACK_IMPORTED_MODULE_1__["default"].post(props.urlMove.replace('__id__', t.id), {
            ...
            case 3:
              ...
              i = tareasList.value.findIndex(function (x) {
                return x.id === data.id;
              });
            ...
            case 4:
              _context2.p = 4;
              _t = _context2.v;
              console.error('Error al mover tarea:', _t);
            case 5:
              return _context2.a(2);
          }
        }, _callee2, null, [[2, 4]]);
    ...
    function _confirmarEliminar() {
      _confirmarEliminar = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(t) {
        var _t2;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.p = _context3.n) {
            ...
            case 1:
              _context3.p = 1;
              _context3.n = 2;
              return axios__WEBPACK_IMPORTED_MODULE_1__["default"].delete(props.urlDestroy.replace('__id__', t.id), {
                headers: {
                  'X-CSRF-TOKEN': props.csrfToken,
                  Accept: 'application/json'
                }
            ...
            case 2:
              tareasList.value = tareasList.value.filter(function (x) {
                return x.id !== t.id;
              });
              _context3.n = 4;
              break;
            case 3:
              _context3.p = 3;
              _t2 = _context3.v;
              console.error('Error al eliminar:', _t2);
            case 4:
              return _context3.a(2);
          }
        }, _callee3, null, [[1, 3]]);
...
/***/ "./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/TareasKanban.vue?vue&type=template&id=769ae6d4"
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/TareasKanban.vue?vue&type=template&id=769ae6d4 ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var _hoisted_3 = ["data-estado", "onDrop"];
var _hoisted_4 = {
...
var _hoisted_20 = {
  class: "relative bg-white dark:bg-gray-800 rounded-xl shadow-xl max-w-lg w-full p-6 border border-gray-200 dark:border-gray-700"
};
var _hoisted_21 = {
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [_cache[18] || (_cache[18] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    class: "mb-6 flex items-center justify-between"
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h1", {
    class: "text-2xl font-bold text-gray-900 dark:text-gray-100"
  }, "Dashboard de Tareas"), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", {
    class: "text-sm text-gray-500 dark:text-gray-400"
  }, "Pendiente · En progreso · Completado")], -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($setup.columnas, function (col) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
      key: col.id,
      class: "column flex-shrink-0 w-80 bg-gray-100 dark:bg-gray-800 rounded-xl p-4 min-h-[400px]",
      "data-estado": col.id,
      onDragover: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)($setup.onDragOver, ["prevent"]),
      onDrop: function onDrop($event) {
        return $setup.onDrop($event, col.id);
      }
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h3", {
      class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["font-semibold text-gray-700 dark:text-gray-300", col.clase])
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(col.label), 3 /* TEXT, CLASS */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_5, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.tareasPorColumna(col.id).length), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_6, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($setup.tareasPorColumna(col.id), function (t) {
      return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
        ...
        onDragstart: function onDragstart($event) {
          return $setup.onDragStart($event, t);
        },
        onDragend: $setup.onDragEnd
      }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_8, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_9, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_10, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(t.titulo), 1 /* TEXT */), t.descripcion ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_11, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(t.descripcion), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_12, [t.prioridad ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
        key: 0,
        class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["px-1.5 py-0.5 rounded text-xs font-medium", $setup.prioridadClase(t.prioridad)])
      }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.prioridadLabel(t.prioridad)), 3 /* TEXT, CLASS */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $props.canCreate ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
        key: 1,
        type: "button",
        onClick: function onClick($event) {
          return $setup.abrirEditar(t);
        },
      ...
      })], -1 /* CACHED */)])), 8 /* PROPS */, _hoisted_13)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $props.canCreate ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
        key: 2,
        type: "button",
        onClick: function onClick($event) {
          return $setup.confirmarEliminar(t);
        },
      ...
      })], -1 /* CACHED */)])), 8 /* PROPS */, _hoisted_14)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])]), t.asignado || t.fecha_vencimiento ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_15, [t.asignado ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_16, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(t.asignado.name), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), t.fecha_vencimiento ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_17, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.formatFecha(t.fecha_vencimiento)), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 40 /* PROPS, NEED_HYDRATION */, _hoisted_7);
    }), 128 /* KEYED_FRAGMENT */))]), $props.canCreate ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
      key: 0,
      type: "button",
      onClick: function onClick($event) {
        return $setup.abrirNueva(col.id);
      },
    ...
    }, " + Nueva tarea ", 8 /* PROPS */, _hoisted_18)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 40 /* PROPS, NEED_HYDRATION */, _hoisted_3);
  }), 64 /* STABLE_FRAGMENT */))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Modal "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_19, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    class: "absolute inset-0 bg-black/50",
    onClick: $setup.cerrarModal
  }), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_20, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_21, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($setup.editando ? 'Editar tarea' : 'Nueva tarea'), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("form", {
    onSubmit: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)($setup.guardar, ["prevent"])
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_22, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [_cache[8] || (_cache[8] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
  }, "Título", -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
    "onUpdate:modelValue": _cache[0] || (_cache[0] = function ($event) {
      return $setup.form.titulo = $event;
    }),
    type: "text",
    required: "",
    class: "w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 dark:text-gray-100",
    placeholder: "Título de la tarea"
  }, null, 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $setup.form.titulo]])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [_cache[9] || (_cache[9] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
    ...
    "onUpdate:modelValue": _cache[1] || (_cache[1] = function ($event) {
      return $setup.form.descripcion = $event;
    }),
    rows: "3",
    class: "w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 dark:text-gray-100",
    placeholder: "Descripción (opcional)"
  }, null, 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $setup.form.descripcion]])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_23, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [_cache[11] || (_cache[11] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
    ...
    class: "w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 dark:text-gray-100"
  }, _toConsumableArray(_cache[10] || (_cache[10] = [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", {
    value: "pendiente"
  }, "Pendiente", -1 /* CACHED */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", {
    value: "en_progreso"
  }, "En progreso", -1 /* CACHED */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", {
    value: "completado"
  }, "Completado", -1 /* CACHED */)])), 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $setup.form.estado]])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [_cache[13] || (_cache[13] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
    ...
    "onUpdate:modelValue": _cache[3] || (_cache[3] = function ($event) {
      return $setup.form.prioridad = $event;
    }),
    class: "w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 dark:text-gray-100"
  }, _toConsumableArray(_cache[12] || (_cache[12] = [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", {
    value: ""
  }, "Sin prioridad", -1 /* CACHED */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", {
    value: "baja"
    ...
    value: "alta"
  }, "Alta", -1 /* CACHED */)])), 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $setup.form.prioridad]])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_24, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [_cache[15] || (_cache[15] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
  }, "Asignado", -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("select", {
    "onUpdate:modelValue": _cache[4] || (_cache[4] = function ($event) {
      return $setup.form.asignado_id = $event;
    }),
    class: "w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 dark:text-gray-100"
  }, [_cache[14] || (_cache[14] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("option", {
    value: null
  }, "Sin asignar", -1 /* CACHED */)), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($props.usuarios, function (u) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("option", {
      key: u.usuario_id,
      value: u.usuario_id
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(u.name), 9 /* TEXT, PROPS */, _hoisted_25);
  }), 128 /* KEYED_FRAGMENT */))], 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelSelect, $setup.form.asignado_id]])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [_cache[16] || (_cache[16] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", {
    class: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1"
  }, "Vencimiento", -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
    "onUpdate:modelValue": _cache[5] || (_cache[5] = function ($event) {
      return $setup.form.fecha_vencimiento = $event;
    }),
    type: "date",
    class: "w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 dark:text-gray-100"
  }, null, 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $setup.form.fecha_vencimiento]])])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
  ...
  }, "Cancelar"), _cache[17] || (_cache[17] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "submit",
    class: "px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700"
  }, "Guardar", -1 /* CACHED */))])], 32 /* NEED_HYDRATION */)])], 512 /* NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vShow, $setup.modalOpen]])]);
}
...
/***/ "./resources/js/components/TareasKanban.vue"
/*!**************************************************!*\
  !*** ./resources/js/components/TareasKanban.vue ***!
  \**************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _TareasKanban_vue_vue_type_template_id_769ae6d4__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./TareasKanban.vue?vue&type=template&id=769ae6d4 */ "./resources/js/components/TareasKanban.vue?vue&type=template&id=769ae6d4");
/* harmony import */ var _TareasKanban_vue_vue_type_script_setup_true_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TareasKanban.vue?vue&type=script&setup=true&lang=js */ "./resources/js/components/TareasKanban.vue?vue&type=script&setup=true&lang=js");
...
;
const __exports__ = /*#__PURE__*/(0,_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_TareasKanban_vue_vue_type_script_setup_true_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_TareasKanban_vue_vue_type_template_id_769ae6d4__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/TareasKanban.vue"]])
/* hot reload */
if (false) // removed by dead control flow
{}
...
/***/ "./resources/js/components/TareasKanban.vue?vue&type=script&setup=true&lang=js"
/*!*************************************************************************************!*\
  !*** ./resources/js/components/TareasKanban.vue?vue&type=script&setup=true&lang=js ***!
  \*************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* reexport safe */ _node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_TareasKanban_vue_vue_type_script_setup_true_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"])
/* harmony export */ });
/* harmony import */ var _node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_TareasKanban_vue_vue_type_script_setup_true_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./TareasKanban.vue?vue&type=script&setup=true&lang=js */ "./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/TareasKanban.vue?vue&type=script&setup=true&lang=js");
 

/***/ },

/***/ "./resources/js/components/TareasKanban.vue?vue&type=template&id=769ae6d4"
/*!********************************************************************************!*\
  !*** ./resources/js/components/TareasKanban.vue?vue&type=template&id=769ae6d4 ***!
  \********************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_TareasKanban_vue_vue_type_template_id_769ae6d4__WEBPACK_IMPORTED_MODULE_0__.render)
/* harmony export */ });
/* harmony import */ var _node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_TareasKanban_vue_vue_type_template_id_769ae6d4__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./TareasKanban.vue?vue&type=template&id=769ae6d4 */ "./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/TareasKanban.vue?vue&type=template&id=769ae6d4");


/***/ },

/***/ "./resources/js/tareas-dashboard.js"
/*!******************************************!*\
  !*** ./resources/js/tareas-dashboard.js ***!
  \******************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _components_TareasKanban_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/components/TareasKanban.vue */ "./resources/js/components/TareasKanban.vue");




var el = document.getElementById('tareas-kanban-app');
if (el) {
  var _cfg$canCreate;
  var cfg = typeof window.__TAREAS_KANBAN_CONFIG__ !== 'undefined' ? window.__TAREAS_KANBAN_CONFIG__ : {};
  var app = (0,vue__WEBPACK_IMPORTED_MODULE_2__.createApp)(_components_TareasKanban_vue__WEBPACK_IMPORTED_MODULE_3__["default"], {
    tareas: cfg.tareas || [],
    usuarios: cfg.usuarios || [],
    canCreate: (_cfg$canCreate = cfg.canCreate) !== null && _cfg$canCreate !== void 0 ? _cfg$canCreate : false,
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./resources/js/tareas-dashboard.js")))
