...
/***/ "./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/WhatsAppTestN8n.vue?vue&type=script&lang=js"
/*!**********************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/WhatsAppTestN8n.vue?vue&type=script&lang=js ***!
  \**********************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var STORAGE_KEY = 'infinity.wa.testN8n.tel';
var ATAJOS = [{
  label: 'Hola',
  text: 'Hola'
}, {
  label: 'Quiero wifi',
  text: 'Hola, quiero wifi'
}, {
  label: 'Ubicación',
  text: 'Tres de Mayo https://share.google/lbSE4qK4z27koOCwX'
}, {
  label: 'Cédula',
  text: '75616117'
}, {
  label: 'Plan 20',
  text: 'Cuánto sale el de 20 megas?'
}, {
  label: 'Beneficios',
  text: 'Qué beneficios tiene el estándar y el premium?'
}, {
  label: 'Transferencia',
  text: 'A qué cuenta transfiero?'
}, {
  label: 'Condiciones',
  text: 'Cuáles son las condiciones del servicio?'
}, {
  label: 'Ya pagué',
  text: 'Ya pagué, les mando el comprobante'
}];
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    var saved = typeof localStorage !== 'undefined' ? localStorage.getItem(STORAGE_KEY) : '';
    var tel = saved || this.telInicial || '595000000001';
    return {
      telInput: tel,
      telActivo: tel,
      mensajes: [],
  ...
  computed: {
    flagsLabel: function flagsLabel() {
      var on = Object.entries(this.flags || {}).filter(function (_ref) {
  ...
  methods: {
    ...
    mostrarToast: function mostrarToast(text) {
      var _this = this;
      ...
      window.setTimeout(function () {
        if (_this.toast && _this.toast.text === text) _this.toast = null;
      }, 4000);
    },
    aplicarPayload: function aplicarPayload(data) {
      var _this2 = this;
      if (data.telefono) {
        this.telActivo = data.telefono;
        this.telInput = data.telefono;
        try {
          localStorage.setItem(STORAGE_KEY, data.telefono);
        } catch (_) {/* ignore */}
    ...
    cargarHilo: function cargarHilo() {
      var _this3 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var _yield$window$axios$g, data, _t;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            case 0:
              _this3.loadingHilo = true;
              _context.p = 1;
              _context.n = 2;
              return window.axios.get(_this3.urls.hilo, {
                params: {
                  tel: _this3.telActivo
                }
              });
            case 2:
              _yield$window$axios$g = _context.v;
              data = _yield$window$axios$g.data;
              _this3.aplicarPayload(data);
              _this3.ultimo = {};
              _this3.flags = {};
              _context.n = 4;
              break;
            case 3:
              _context.p = 3;
              _t = _context.v;
              _this3.mostrarToast('No pude cargar el hilo', false);
            case 4:
              _context.p = 4;
              _this3.loadingHilo = false;
              return _context.f(4);
            case 5:
              return _context.a(2);
          }
    ...
    usarNumero: function usarNumero() {
      this.telActivo = (this.telInput || '').replace(/\D+/g, '') || '595000000001';
      this.cargarHilo();
    },
    nuevoNumero: function nuevoNumero() {
      var n = '595000' + String(Math.floor(100000 + Math.random() * 900000));
      this.telInput = n;
      this.telActivo = n;
      this.mensajes = [];
      this.ultimo = {};
    ...
    abrirReciente: function abrirReciente(tel) {
      this.telInput = tel;
      this.telActivo = tel;
      this.cargarHilo();
    },
    ubicacionAprobada: function ubicacionAprobada() {
      var _this4 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        var _yield$window$axios$p, data, _e$response, _e$response2, msg, _t2;
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            ...
            case 1:
              ...
              _context2.p = 2;
              _context2.n = 3;
              return window.axios.post(_this4.urls.ubicacionAprobada, {
                telefono: _this4.telActivo
              }, {
                timeout: 40000,
                headers: {
            ...
            case 3:
              _yield$window$axios$p = _context2.v;
              data = _yield$window$axios$p.data;
              _this4.aplicarPayload(data);
              if (data.error) _this4.mostrarToast(data.error, false);else _this4.mostrarToast('Cobertura aprobada: el agente sigue con los planes');
              _context2.n = 5;
              break;
            case 4:
              _context2.p = 4;
              _t2 = _context2.v;
              msg = ((_e$response = _t2.response) === null || _e$response === void 0 || (_e$response = _e$response.data) === null || _e$response === void 0 ? void 0 : _e$response.error) || ((_e$response2 = _t2.response) === null || _e$response2 === void 0 || (_e$response2 = _e$response2.data) === null || _e$response2 === void 0 ? void 0 : _e$response2.message) || _t2.message || 'Error al llamar n8n';
              _this4.mostrarToast(msg, false);
            case 5:
              _context2.p = 5;
              _this4.enviando = false;
              _this4.$nextTick(function () {
                return _this4.scrollBottom();
              });
    ...
    borrarHilo: function borrarHilo() {
      var _this5 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        var _yield$window$axios$d, data, _t3;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.p = _context3.n) {
            case 0:
              if (window.confirm('¿Borrar este hilo de prueba?')) {
                _context3.n = 1;
                break;
              }
              return _context3.a(2);
            case 1:
              _this5.borrando = true;
              _context3.p = 2;
              _context3.n = 3;
              return window.axios.delete(_this5.urls.borrar, {
                data: {
                  telefono: _this5.telActivo
                },
                headers: {
            ...
            case 3:
              _yield$window$axios$d = _context3.v;
              data = _yield$window$axios$d.data;
              _this5.mensajes = [];
              _this5.ultimo = {};
              _this5.flags = {};
              if (Array.isArray(data.recientes)) _this5.recientes = data.recientes;
              _this5.mostrarToast('Hilo borrado');
              _context3.n = 5;
              break;
            case 4:
              _context3.p = 4;
              _t3 = _context3.v;
              _this5.mostrarToast('No pude borrar el hilo', false);
            case 5:
              _context3.p = 5;
              _this5.borrando = false;
    ...
    enviar: function enviar(texto) {
      var _this6 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
        var mensaje, _yield$window$axios$p2, data, _e$response3, _e$response4, msg, _t4;
        return _regenerator().w(function (_context4) {
          while (1) switch (_context4.p = _context4.n) {
            case 0:
              mensaje = String(texto != null ? texto : _this6.draft).trim();
              if (!(!mensaje || _this6.enviando)) {
                _context4.n = 1;
                break;
              }
              return _context4.a(2);
            case 1:
              _this6.enviando = true;
              if (texto == null) _this6.draft = '';
              _context4.p = 2;
              _context4.n = 3;
              return window.axios.post(_this6.urls.mensaje, {
                telefono: _this6.telActivo,
                mensaje: mensaje
              }, {
                timeout: 40000,
                headers: {
            ...
            case 3:
              _yield$window$axios$p2 = _context4.v;
              data = _yield$window$axios$p2.data;
              _this6.aplicarPayload(data);
              if (data.error) _this6.mostrarToast(data.error, false);
              _context4.n = 5;
              break;
            case 4:
              _context4.p = 4;
              _t4 = _context4.v;
              msg = ((_e$response3 = _t4.response) === null || _e$response3 === void 0 || (_e$response3 = _e$response3.data) === null || _e$response3 === void 0 ? void 0 : _e$response3.error) || ((_e$response4 = _t4.response) === null || _e$response4 === void 0 || (_e$response4 = _e$response4.data) === null || _e$response4 === void 0 ? void 0 : _e$response4.message) || _t4.message || 'Error al llamar n8n';
              _this6.mostrarToast(msg, false);
            case 5:
              _context4.p = 5;
              _this6.enviando = false;
              _this6.$nextTick(function () {
                return _this6.scrollBottom();
              });
...
/***/ "./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/WhatsAppTestN8n.vue?vue&type=template&id=73f9b676"
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/WhatsAppTestN8n.vue?vue&type=template&id=73f9b676 ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var _hoisted_1 = {
  class: "wa-app overflow-hidden rounded-xl border shadow-xl"
};
var _hoisted_2 = {
  class: "flex min-h-[72vh] flex-col md:h-[min(82vh,900px)] md:flex-row"
};
var _hoisted_3 = {
  class: "wa-sidebar flex min-h-0 w-full flex-col md:w-[320px] md:shrink-0 md:border-r"
};
var _hoisted_4 = {
  class: "wa-sidebar-body space-y-2 px-3 py-3"
};
var _hoisted_5 = {
...
var _hoisted_10 = {
  class: "wa-list min-h-0 flex-1 overflow-y-auto border-t"
};
var _hoisted_11 = ["onClick"];
var _hoisted_12 = {
  class: "wa-title font-mono text-[13px]"
};
var _hoisted_13 = {
  class: "wa-muted text-[11px]"
};
var _hoisted_14 = {
  key: 0,
  class: "wa-muted px-3 py-6 text-center text-xs"
};
var _hoisted_15 = {
  class: "flex min-h-0 min-w-0 flex-1 flex-col"
};
var _hoisted_16 = {
  class: "wa-header flex items-center gap-3 px-4 py-3"
};
var _hoisted_17 = {
  class: "min-w-0 flex-1"
};
var _hoisted_18 = {
  class: "wa-muted truncate font-mono text-[11px]"
};
var _hoisted_19 = {
  key: 0,
  class: "rounded-full bg-emerald-600 px-2.5 py-0.5 text-[11px] font-semibold text-white"
};
var _hoisted_20 = {
  ref: "scrollEl",
  class: "wa-wallpaper min-h-0 flex-1 overflow-y-auto px-3 py-3 sm:px-8"
};
var _hoisted_21 = {
  key: 0,
...
var _hoisted_22 = {
  class: "wa-msg-body whitespace-pre-wrap text-[14.2px] leading-5"
};
var _hoisted_23 = {
  class: "wa-muted mt-0.5 text-right text-[10px]"
};
var _hoisted_24 = {
  key: 0
};
...
var _hoisted_27 = {
  key: 0,
  class: "wa-warn border-t px-4 py-2 text-xs"
};
var _hoisted_28 = {
  key: 1,
  class: "wa-muted border-t px-4 py-1.5 text-[11px]"
};
var _hoisted_29 = {
  class: "wa-sidebar-body flex flex-wrap gap-1.5 border-t px-3 py-2"
};
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_1, [$data.toast ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
    key: 0,
    class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["wa-toast border-b px-4 py-2 text-sm", $data.toast.ok ? 'wa-toast-ok' : 'wa-toast-err'])
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.toast.text) + " ", 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    class: "ml-2 text-xs underline opacity-70",
    onClick: _cache[0] || (_cache[0] = function ($event) {
      return $data.toast = null;
    })
  }, "cerrar")], 2 /* CLASS */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("aside", _hoisted_3, [_cache[11] || (_cache[11] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    class: "wa-header px-4 py-3"
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", {
    class: "wa-title text-sm font-medium"
  }, "Número inventado"), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", {
    class: "wa-muted mt-0.5 text-[11px]"
  }, "Empieza con 595000 · nunca se manda a Meta")], -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("input", {
    "onUpdate:modelValue": _cache[1] || (_cache[1] = function ($event) {
      return $data.telInput = $event;
    }),
    type: "text",
    inputmode: "numeric",
    ...
    onKeydown: _cache[2] || (_cache[2] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.withKeys)((0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function () {
      return $options.usarNumero && $options.usarNumero.apply($options, arguments);
    }, ["prevent"]), ["enter"]))
  }, null, 544 /* NEED_HYDRATION, NEED_PATCH */), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.telInput]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_5, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    class: "wa-chip wa-chip-on rounded-full px-3 py-1 text-[11px] font-semibold",
    onClick: _cache[3] || (_cache[3] = function () {
      return $options.usarNumero && $options.usarNumero.apply($options, arguments);
    })
  }, " Usar número "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    class: "wa-chip rounded-full px-3 py-1 text-[11px] font-semibold",
    onClick: _cache[4] || (_cache[4] = function () {
      return $options.nuevoNumero && $options.nuevoNumero.apply($options, arguments);
    })
  }, " Otro número "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    ...
    onClick: _cache[5] || (_cache[5] = function () {
      return $options.ubicacionAprobada && $options.ubicacionAprobada.apply($options, arguments);
    })
  }, " Ubicación aprobada ", 8 /* PROPS */, _hoisted_6), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "button",
    class: "wa-chip rounded-full px-3 py-1 text-[11px] font-semibold text-rose-700",
    disabled: $data.borrando,
    onClick: _cache[6] || (_cache[6] = function () {
      return $options.borrarHilo && $options.borrarHilo.apply($options, arguments);
    })
  }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.borrando ? '...' : 'Borrar hilo'), 9 /* TEXT, PROPS */, _hoisted_7)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_8, [_cache[10] || (_cache[10] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)("Activo: ", -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_9, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.telActivo), 1 /* TEXT */)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_10, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.recientes, function (r) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
      key: r.telefono,
      type: "button",
      class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["wa-row block w-full border-b px-3 py-2.5 text-left", $data.telActivo === r.telefono ? 'wa-row-active' : '']),
      onClick: function onClick($event) {
        return $options.abrirReciente(r.telefono);
      }
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_12, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(r.telefono), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_13, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(r.ultimo_at || ''), 1 /* TEXT */)], 10 /* CLASS, PROPS */, _hoisted_11);
  }), 128 /* KEYED_FRAGMENT */)), !$data.recientes.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_14, "Todavía no hay pruebas.")) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("section", _hoisted_15, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_16, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_17, [_cache[12] || (_cache[12] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", {
    class: "wa-title truncate text-sm font-medium"
  }, "Cliente de prueba", -1 /* CACHED */)), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_18, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.telActivo), 1 /* TEXT */)]), $data.ultimo.modo ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_19, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.ultimo.modo), 1 /* TEXT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_20, [$data.loadingHilo && !$data.mensajes.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_21, "Cargando hilo...")) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.mensajes, function (m) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", {
      key: m.id,
      class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["mb-1.5 flex", m.direccion === 'salida' ? 'justify-end' : 'justify-start'])
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
      class: (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["wa-bubble relative max-w-[85%] px-2.5 py-1.5 shadow-sm sm:max-w-[70%]", m.direccion === 'salida' ? 'wa-bubble-out' : 'wa-bubble-in'])
    }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_22, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(m.cuerpo), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", _hoisted_23, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(m.hora) + " ", 1 /* TEXT */), m.direccion === 'salida' ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", _hoisted_24, " · agente")) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])], 2 /* CLASS */)], 2 /* CLASS */);
  }), 128 /* KEYED_FRAGMENT */)), $data.enviando ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_25, _toConsumableArray(_cache[13] || (_cache[13] = [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
    class: "wa-bubble wa-bubble-out relative max-w-[70%] px-2.5 py-1.5 text-[13px] opacity-70"
  }, " Pensando... ", -1 /* CACHED */)])))) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), !$data.loadingHilo && !$data.mensajes.length ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_26, " Escribí como si fueras el cliente. El agente responde acá, sin WhatsApp real. ")) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)], 512 /* NEED_PATCH */), $data.ultimo.error ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_27, " n8n: " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.ultimo.error), 1 /* TEXT */)) : $data.ultimo.n8n_latency_ms ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", _hoisted_28, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.ultimo.n8n_latency_ms) + " ms ", 1 /* TEXT */), $data.ultimo.escalate ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    key: 0
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" · escala " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.ultimo.motivo_escalado || ''), 1 /* TEXT */)], 64 /* STABLE_FRAGMENT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), $options.flagsLabel ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    key: 1
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)(" · " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($options.flagsLabel), 1 /* TEXT */)], 64 /* STABLE_FRAGMENT */)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)])) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_29, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($data.atajos, function (atajo) {
    return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
      key: atajo.label,
      type: "button",
      ...
      disabled: $data.enviando,
      onClick: function onClick($event) {
        return $options.enviar(atajo.text);
      }
    }, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(atajo.label), 9 /* TEXT, PROPS */, _hoisted_30);
  }), 128 /* KEYED_FRAGMENT */))]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("form", {
    class: "wa-composer border-t px-3 py-2.5",
    onSubmit: _cache[9] || (_cache[9] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function ($event) {
      return $options.enviar();
    }, ["prevent"]))
  }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_31, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)((0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("textarea", {
    "onUpdate:modelValue": _cache[7] || (_cache[7] = function ($event) {
      return $data.draft = $event;
    }),
    rows: "1",
  ...
  }, null, 40 /* PROPS, NEED_HYDRATION */, _hoisted_32), [[vue__WEBPACK_IMPORTED_MODULE_0__.vModelText, $data.draft]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "submit",
    class: "wa-send flex h-10 w-10 shrink-0 items-center justify-center rounded-full disabled:opacity-40",
    disabled: $data.enviando || !$data.draft.trim()
  ...
  })], -1 /* CACHED */)])), 8 /* PROPS */, _hoisted_33)])], 32 /* NEED_HYDRATION */)])])]);
}
...
/***/ "./resources/js/components/WhatsAppTestN8n.vue"
/*!*****************************************************!*\
  !*** ./resources/js/components/WhatsAppTestN8n.vue ***!
  \*****************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _WhatsAppTestN8n_vue_vue_type_template_id_73f9b676__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./WhatsAppTestN8n.vue?vue&type=template&id=73f9b676 */ "./resources/js/components/WhatsAppTestN8n.vue?vue&type=template&id=73f9b676");
/* harmony import */ var _WhatsAppTestN8n_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./WhatsAppTestN8n.vue?vue&type=script&lang=js */ "./resources/js/components/WhatsAppTestN8n.vue?vue&type=script&lang=js");
...
;
const __exports__ = /*#__PURE__*/(0,_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_WhatsAppTestN8n_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_WhatsAppTestN8n_vue_vue_type_template_id_73f9b676__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/WhatsAppTestN8n.vue"]])
/* hot reload */
if (false) // removed by dead control flow
{}
...
/***/ "./resources/js/components/WhatsAppTestN8n.vue?vue&type=script&lang=js"
/*!*****************************************************************************!*\
  !*** ./resources/js/components/WhatsAppTestN8n.vue?vue&type=script&lang=js ***!
  \*****************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* reexport safe */ _node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_WhatsAppTestN8n_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"])
/* harmony export */ });
/* harmony import */ var _node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_WhatsAppTestN8n_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./WhatsAppTestN8n.vue?vue&type=script&lang=js */ "./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/WhatsAppTestN8n.vue?vue&type=script&lang=js");
 

/***/ },

/***/ "./resources/js/components/WhatsAppTestN8n.vue?vue&type=template&id=73f9b676"
/*!***********************************************************************************!*\
  !*** ./resources/js/components/WhatsAppTestN8n.vue?vue&type=template&id=73f9b676 ***!
  \***********************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_WhatsAppTestN8n_vue_vue_type_template_id_73f9b676__WEBPACK_IMPORTED_MODULE_0__.render)
/* harmony export */ });
/* harmony import */ var _node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_WhatsAppTestN8n_vue_vue_type_template_id_73f9b676__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./WhatsAppTestN8n.vue?vue&type=template&id=73f9b676 */ "./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/WhatsAppTestN8n.vue?vue&type=template&id=73f9b676");
...
"use strict";
/*!*******************************************!*\
  !*** ./resources/js/whatsapp-test-n8n.js ***!
  \*******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _bootstrap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js");
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.esm-bundler.js");
/* harmony import */ var _components_WhatsAppTestN8n_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/components/WhatsAppTestN8n.vue */ "./resources/js/components/WhatsAppTestN8n.vue");



var el = document.getElementById('whatsapp-test-n8n-app');
if (el) {
  var cfg = typeof window.__WHATSAPP_TEST_N8N_CONFIG__ !== 'undefined' ? window.__WHATSAPP_TEST_N8N_CONFIG__ : {};
  (0,vue__WEBPACK_IMPORTED_MODULE_1__.createApp)({
    render: function render() {
      return (0,vue__WEBPACK_IMPORTED_MODULE_1__.h)(_components_WhatsAppTestN8n_vue__WEBPACK_IMPORTED_MODULE_2__["default"], {
