...
/***/ "./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/MapaClientesActivos.vue?vue&type=script&setup=true&lang=js"
/*!*************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/MapaClientesActivos.vue?vue&type=script&setup=true&lang=js ***!
  \*************************************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    function getHomeMarkerIcon(google) {
      ...
      var svg = '<svg xmlns="http://www.w3.org/2000/svg" width="' + w + '" height="' + h + '" viewBox="0 0 ' + w + ' ' + h + '">' + '<rect width="100%" height="100%" fill="none"/>' + '<g transform="translate(12,10)">' + '<path fill="' + color + '" stroke="#1f2937" stroke-width="0.45" stroke-linejoin="round" d="M10 20v-6h4v6h5v-8h3L12 3 2 12h3v8z"/>' + '</g></svg>';
      return {
    ...
    function loadGoogleMaps() {
      return new Promise(function (resolve, reject) {
        ...
        var scriptId = 'google-maps-api-mapa-clientes-activos';
        ...
        window.__mapaClientesActivosMapsReady__ = function () {
          resolve(window.google);
        };
        var script = document.createElement('script');
        script.id = scriptId;
        script.src = "https://maps.googleapis.com/maps/api/js?key=".concat(encodeURIComponent(props.apiKey), "&callback=__mapaClientesActivosMapsReady__");
        script.async = true;
        script.defer = true;
    ...
    function syncMarkerVisibility() {
      ...
      var visibleCount = 0;
      markerMeta.forEach(function (_ref2) {
        var marker = _ref2.marker,
          clienteId = _ref2.clienteId;
        var punto = puntosByClienteId[clienteId];
        var visible = Boolean(punto && pasaFiltroPingEstado(punto));
          ...
          while (1) switch (_context2.n) {
            ...
            case 1:
              ...
              props.puntos.forEach(function (p) {
                puntosByClienteId[p.cliente_id] = _objectSpread({}, p);
              });
            ...
            case 2:
              ...
              batch.forEach(function (p) {
                ...
                marker.addListener('click', function () {
                  var punto = puntosByClienteId[p.cliente_id] || p;
            ...
            case 4:
              if (props.puntos.filter(pasaFiltroPingEstado).length > 1) {
                ...
                visible = props.puntos.find(pasaFiltroPingEstado);
                if (visible) {
                  map.setCenter({
                    lat: visible.lat,
                    lng: visible.lon
    ...
    function applyPingEstados(estados, actualizadoAt) {
      ...
      markerMeta.forEach(function (_ref3) {
        var _ping$estado, _ping$en_linea, _ping$total, _ping$latencia_ms, _ping$verificado_at;
        var marker = _ref3.marker,
          clienteId = _ref3.clienteId;
        var ping = estados[clienteId];
        if (!ping) return;
        var punto = puntosByClienteId[clienteId];
        if (!punto) return;
        punto.ping_estado = (_ping$estado = ping.estado) !== null && _ping$estado !== void 0 ? _ping$estado : 'unknown';
        punto.ping_en_linea = (_ping$en_linea = ping.en_linea) !== null && _ping$en_linea !== void 0 ? _ping$en_linea : 0;
        punto.ping_total = (_ping$total = ping.total) !== null && _ping$total !== void 0 ? _ping$total : 0;
    ...
    function refrescarPingEstados() {
      return _refrescarPingEstados.apply(this, arguments);
    }
    function _refrescarPingEstados() {
      _refrescarPingEstados = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        var ids, params, response, data, _t2;
        return _regenerator().w(function (_context3) {
          while (1) switch (_context3.p = _context3.n) {
            case 0:
              if (!(!props.urlPingEstados || !props.puntos.length)) {
                _context3.n = 1;
                break;
              }
              return _context3.a(2);
            case 1:
              ids = props.puntos.map(function (p) {
                return p.cliente_id;
              }).filter(Boolean);
              if (ids.length) {
                _context3.n = 2;
            ...
            case 2:
              ...
              ids.forEach(function (id) {
                return params.append('cliente_ids[]', String(id));
              });
              if (props.nodoId) {
              ...
              _context3.p = 3;
              _context3.n = 4;
              return fetch("".concat(props.urlPingEstados, "?").concat(params.toString()), {
                headers: {
    ...
    var __returned__ = {
      ...
      get puntosByClienteId() {
        return puntosByClienteId;
      },
      set puntosByClienteId(v) {
        puntosByClienteId = v;
      },
      ...
      syncMarkerVisibility: syncMarkerVisibility,
      initMap: initMap,
      escapeHtml: escapeHtml,
      updateUltimaActualizacionLabel: updateUltimaActualizacionLabel,
      applyPingEstados: applyPingEstados,
      refrescarPingEstados: refrescarPingEstados,
...
/***/ "./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/MapaClientesActivos.vue?vue&type=template&id=8625ecec"
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/MapaClientesActivos.vue?vue&type=template&id=8625ecec ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./resources/js/components/MapaClientesActivos.vue"
/*!*********************************************************!*\
  !*** ./resources/js/components/MapaClientesActivos.vue ***!
  \*********************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _MapaClientesActivos_vue_vue_type_template_id_8625ecec__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./MapaClientesActivos.vue?vue&type=template&id=8625ecec */ "./resources/js/components/MapaClientesActivos.vue?vue&type=template&id=8625ecec");
/* harmony import */ var _MapaClientesActivos_vue_vue_type_script_setup_true_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./MapaClientesActivos.vue?vue&type=script&setup=true&lang=js */ "./resources/js/components/MapaClientesActivos.vue?vue&type=script&setup=true&lang=js");
...
;
const __exports__ = /*#__PURE__*/(0,_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_MapaClientesActivos_vue_vue_type_script_setup_true_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_MapaClientesActivos_vue_vue_type_template_id_8625ecec__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/MapaClientesActivos.vue"]])
/* hot reload */
if (false) // removed by dead control flow
{}
...
/***/ "./resources/js/components/MapaClientesActivos.vue?vue&type=script&setup=true&lang=js"
/*!********************************************************************************************!*\
  !*** ./resources/js/components/MapaClientesActivos.vue?vue&type=script&setup=true&lang=js ***!
  \********************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* reexport safe */ _node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_MapaClientesActivos_vue_vue_type_script_setup_true_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"])
/* harmony export */ });
/* harmony import */ var _node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_MapaClientesActivos_vue_vue_type_script_setup_true_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./MapaClientesActivos.vue?vue&type=script&setup=true&lang=js */ "./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/MapaClientesActivos.vue?vue&type=script&setup=true&lang=js");
 

/***/ },

/***/ "./resources/js/components/MapaClientesActivos.vue?vue&type=template&id=8625ecec"
/*!***************************************************************************************!*\
  !*** ./resources/js/components/MapaClientesActivos.vue?vue&type=template&id=8625ecec ***!
  \***************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_MapaClientesActivos_vue_vue_type_template_id_8625ecec__WEBPACK_IMPORTED_MODULE_0__.render)
/* harmony export */ });
/* harmony import */ var _node_modules_laravel_mix_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_MapaClientesActivos_vue_vue_type_template_id_8625ecec__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./MapaClientesActivos.vue?vue&type=template&id=8625ecec */ "./node_modules/laravel-mix/node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/components/MapaClientesActivos.vue?vue&type=template&id=8625ecec");


/***/ },

/***/ "./resources/js/mapa-clientes-activos.js"
/*!***********************************************!*\
  !*** ./resources/js/mapa-clientes-activos.js ***!
  \***********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _components_MapaClientesActivos_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @/components/MapaClientesActivos.vue */ "./resources/js/components/MapaClientesActivos.vue");




var el = document.getElementById('mapa-clientes-activos-app');
if (el) {
  var cfg = typeof window.__MAPA_CLIENTES_ACTIVOS_CONFIG__ !== 'undefined' ? window.__MAPA_CLIENTES_ACTIVOS_CONFIG__ : {};
  var app = (0,vue__WEBPACK_IMPORTED_MODULE_2__.createApp)(_components_MapaClientesActivos_vue__WEBPACK_IMPORTED_MODULE_3__["default"], {
    apiKey: cfg.apiKey || '',
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app"], () => (__webpack_require__("./resources/js/mapa-clientes-activos.js")))
